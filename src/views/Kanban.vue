...
<template>
    <div  style=" height:100vh; width:100%;">
        ...
        <div class="japOverFlowing">
            ...
            <div class="cardJap1" v-for="(board, x) in boardSpec2" :key="x">
                <!-- {{ board.task.length }} -->
                <Board :arrayIndex="x" :boardSpec="board"  />
            </div>    
        </div>
    ...
    computed:{
        ...
        getBoardSpec()
          { 
               ...
               return this.$store.state.boardSpec
        ...
        setBoardOrder()
          {
              let obj = {}
              let objTitle ={}
              for (let x = 0; x < this.boardSpec2.length; x++)
                {
